...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/11/24 17:05:55 by gpueo--g          #+#    #+#             */
/*   Updated: 2014/12/14 11:11:27 by gpueo--g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				disp_arg		(t_arg *p_arg, int ac, char **av,
										int nb_arg);
...
void				get_link		(t_stat *p_stat, t_dir *file, t_lst *lst,
										t_data *p_data);
...
void				disp_list		(t_lst *lst, t_lst *first, int *block,
										t_max *max);
